...
const NoLogUser = () => {
    ...
    //     if (confirmDelete) {
    //         try {
    //             await axios.delete(`http://118.70.127.173:8000/former-employees/${id}/delete`);
                                        ...
                                        <tr key={item.formerEmployee.id}>
                                            ...
                                            <td>
                                                <div className="button-container">
                                                    <button style={{ background: 'red' }} onClick={() => handleDeleteClick(item.mac)}>
                                                        <FaTrash />
                                                    </button>
                                                </div>
                                            </td>
